...
const AboutMe = () => {
  ...
  // Use useColorModeValue to set colors based on the theme
  const textColor = useColorModeValue('black', 'white')
  const linkColor = useColorModeValue('purple.300', 'purple.300')
  ...
  return (
    <Layout title="About Me">
      <Container>
            ...
            <>
              <Text fontSize="lg" color={textColor} mb={2}>
                LinkedIn: <NextLink href="https://www.linkedin.com/in/lucianlee01/" passHref>
                  <Link color={linkColor} isExternal>lucianlee01</Link>
                </NextLink>
              </Text>
              <Text fontSize="lg" color={textColor} mb={2}>
                GitHub: <NextLink href="https://github.com/luciantlee01/" passHref>
                  <Link color={linkColor} isExternal>luciantlee01</Link>
                </NextLink>
              </Text>
              <Text fontSize="lg" color={textColor} mb={2}>
                Email: <NextLink href="mailto:luciantlee01@gmail.com" passHref>
                  <Link color={linkColor} isExternal>luciantlee01@gmail.com</Link>
                </NextLink>
              </Text>
              <Text fontSize="lg" color={textColor} mb={2}>
                Instagram: <NextLink href="https://www.instagram.com/lucianlee_/" passHref>
                  <Link color={linkColor} isExternal>@lucianlee_</Link>
                </NextLink>
              </Text>
            </>
          )}
        ...
        <Text fontSize="sm" color={textColor} mt={8} textAlign="center">
